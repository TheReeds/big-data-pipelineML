...
??? output "Salida"
    ...
    --- Snapshot #3 (t=30s) ---
      producer : 6 eventos | ultimo: [#  6] offset=   5 | temp=20.2°C | wind=17.1 km/h | at=2026-06-23T14:35:26
      stream   : Waiting for next trigger
      latencia : 177 ms  |  throughput: 0 rps
    +-------------------+-------------------+------+--------+------------+--------+
    |start              |end                |events|avg_temp|avg_humidity|avg_wind|
    +-------------------+-------------------+------+--------+------------+--------+
    |2026-06-23 14:35:00|2026-06-23 14:40:00|2     |20.2    |90.0        |17.1    |
    |2026-06-23 14:35:00|2026-06-23 14:40:00|1     |20.2    |90.0        |17.1    |
    ... (5 líneas omitidas)
